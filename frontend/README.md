...
The v0.21.1 frontend is a React + TypeScript Vite application for the Marine Fleet Control Center.
...
- `src/components/import/`: independently readable presentation components for upload, detection, mapping, validation, and review.
- `src/components/VesselMap.tsx`: public entry point for the raster world map with interactive panning, zooming, metric-shaded routes, and vessel overlays.
- `src/components/map/`: raster, route, control, replay, and legend rendering boundaries.
- `src/hooks/`: focused dashboard selection, telemetry-query, replay, and notification state.
