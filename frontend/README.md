...
The v0.9.0 frontend foundation is a React + TypeScript Vite application for the Marine Fleet Control Center.

It provides the shared desktop shell, a typed backend health client, TanStack Query server-state wiring, a root error boundary, Tailwind CSS setup, and English/French UI selection persisted in browser storage.
