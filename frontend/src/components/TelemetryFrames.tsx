...
const frameColumns: Array<{ key: keyof TelemetryRecord; labelKey: string }> = [{ key: 'timestamp', labelKey: 'telemetryFrames.columnTimestamp' }, { key: 'latitude_deg', labelKey: 'telemetryFrames.columnLatitude' }, { key: 'longitude_deg', labelKey: 'telemetryFrames.columnLongitude' }, { key: 'sog_knots', labelKey: 'telemetryFrames.columnSog' }, { key: 'heading_deg', labelKey: 'telemetryFrames.columnHeading' }, { key: 'course_deg', labelKey: 'telemetryFrames.columnCourse' }]
