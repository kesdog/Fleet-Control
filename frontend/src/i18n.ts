...
const en = {
  app: { name: 'Fleet Control Center', version: 'World map v0.11.0' },
...
const fr = {
  app: { name: 'Centre de controle de flotte', version: 'Carte mondiale v0.11.0' },
